...
function [combined_elecX,combined_elec,All_lat,All_lon,All_HGT]=density (Glon,Glat,Gheight,year,dn,hry)
  % this Code is used in generating IRI2016 densities used as Background in 4D-var 
  % The code might need to be revised to perform better 
  % the functions call an extern excutable generated from a  modified
  % IRI-2016 source code
