function [Jeju,IChe,Okin,Koku,Wakk,Jeju_ion,IChe_ion,Okin_ion,Koku_ion,Wakk_ion]=get_iondata_koreax(All_lat,All_lon,All_HGT,Xv,Year, DOY, Time_needed, Ionosonde_data_Loc )
  ...
  % Pc or Windows 
    ...
    % Open the ionosonde file and get the data 
    fidI = fopen([Ionosonde_data_Loc,slashx,num2str(Year),DOY_str,'_foF2_5station.txt']); 
    output = textscan(fidI, '%f %f %f %f %f %f %f %f %f', 'headerLines',1);
    fclose(fidI); 
