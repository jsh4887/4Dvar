function [dH,db,bError, Rxinfo]=creat_H_b_bError (year,DOY,Time,d_Time,Elevation,numbstatn,satheight,All_HGT,All_lat,All_lon,min_dist_stn,Data_location)
...
% 2019-july-02
    ...
    [infm]= fast_read_CMN4(year,DOY,Time,d_Time, Elevation,latstart,latend,lonstart,lonend,numbstatn,satheight,min_dist_stn,Data_location);
    ...
    [real_STEC] =  removeJASON_PTEC_4DVAR_new(elev,STEC,vtec,sun_up_down);
    b = real_STEC*1E16; % data without PTEC
