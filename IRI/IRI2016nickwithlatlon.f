...
c
       ...
       print *,'jmag(=0/1,geog/geom),latbegin, latstep, latend', 
   &       'lonbegin longstep,longend'
        read(2,*) jm,latbegin,latstep,latend,lonbegin,longstep,longend
c        read(2,*) jm,xlat,xlon
        do 111 xlat = latend, latstep, latbegin
		do 112 xlon = longend,longstep,lonbegin
        print *, xlon,xlat
