...
%% Define the year and DOY being processed
    ...
    Year = 2015; 
    DOYS = [074,075,076,077];%, 075, 76]%, 77];% 77];%, 75, 76, 77];%,077];%, 074, 075]; 
...
%% ~~~~~~~ Define the folders needed during computation  ~~~~~~~ %%
    ...
    working_dir = '/root/Desktop/4DVar/Seheon/Four_Dvar_New';
    ...
    Final_solution_flder = '/root/Desktop/4DVar/Seheon/Four_Dvar_New/Final_solution'; 
    ...
    Temp_fld_Loc = '/root/Desktop/4DVar/Seheon/Four_Dvar_New'; 
    ...
    % Ionosonde_data_Loc = '/data/Users/Seheon/Data_STEC_CMN_folder'; 
 ...
 %%  ~~~~~~~ Define parameters to used in computation   ~~~~~~~   %%
   ...
   %  ~~~~~~~ Definition of assimilation window and correlation times (Tau) ~~~~~~~ 
     ...
     tauhours   = [0.5:0.5:6];         % correlation time in hours (Tau) exp(-deltaT/tau)
    ...
    for tt=1:length(tauhours)
        
	taustr = num2str(tauhours(tt));
        taustr(taustr == '.') = '_';
        Final_solution_flder = ['/root/Desktop/4DVar/Seheon/Four_Dvar_New/Final_solution_tau_', taustr]
 ...
 %%  ~~~~~~~ Computation begins below   ~~~~~~~  %% 
    ...
    for DOY =DOYS
        ...
        disp(['Total Grid cells: ', num2str(numgrid)])
         ...
         tau = tauhours(tt)*60*60; % hours to seconds 
...
%                               end 
                        ...
                        if corrBcompuT ~=1
                             ...
                             cov_B_matrix2(All_lat,All_lon,All_HGT,RXo,Blocation,Bmatfactor,type_Bcov)  
